...
import 'src/core/theme/app_design_tokens.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: AppDesignTokens.appBackground,
        // Customize NavigationBar to be less purple/tinted
        navigationBarTheme: NavigationBarThemeData(
          height: AppDesignTokens.navBarHeight,
          backgroundColor: AppDesignTokens.appSurface,
        ...
        cardTheme: CardThemeData(
          color: AppDesignTokens.appSurface,
          elevation: AppDesignTokens.elevationSoft,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(AppDesignTokens.radiusM),
          ),
          surfaceTintColor: Colors.transparent,
          shadowColor: AppDesignTokens.cardShadowColor,
        ),
      ),
